...
<body>
    ...
    <form method="post" action="TechServlet">
    ...
    <table align="center" cellpadding="5" cellspacing="5" border="1">
         ...
         <td><input type="number" name="id"id="id" placeholder="id"></td>
          <td> <input type="button" class="add-row" value="Add Techtoch"></td>
    	  <td><button type="submit" class="delete-row">Tick checkbox then Refresh</button><br></td>
         </tr>
